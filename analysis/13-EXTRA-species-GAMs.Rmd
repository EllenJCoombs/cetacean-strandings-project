...
This RMarkdown document shows the code for running GAMs for each individual species, using the same covariates as used in `12-generalised-additive-models.Rmd`. It is not part of the main analysis shown in the paper but is mentioned in the analyses and supplementary information. 
