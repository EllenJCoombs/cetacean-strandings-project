...
1. Cleaning and standardising variables the Natural History Museum (NHM), Cetacean Stranding Investigation Programme (CSIP) and Irish Whale and Dolphin Group (IWDG) datasets for binding 
2. Cleaning and foramtting dates in the NHM and CSIP datasets
3. Binding the 3 datasets (NHM + CSIP first, followed by IWDG which was aquired at a later date)
