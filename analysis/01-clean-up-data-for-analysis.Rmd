...
Use 'mutuate' (dplyr package) to change "beg" "mid" "end" and "Summer" "Winter" etc. which appear in some records in the NHM dataset. The dates are mutated as follows: 
