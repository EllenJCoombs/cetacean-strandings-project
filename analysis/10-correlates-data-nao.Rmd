...
No prerequisites are required for this code to run. This code reads in NOA data from [University Corporation for Atmospheric Research] (https://climatedataguide.ucar.edu/sites/default/files/nao_station_annual.txt), see Supplemental Information for details. 
