...
Before being able to plot Figure 1, we need to gather the data for doing so. This dataframe contains Year, Species and total number of strandings for each species for that year. 
