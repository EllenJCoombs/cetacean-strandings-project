...
#SW England = Devon, Corwnall and Somerset. Total area = 14,440 km^2
#W Scotland = Argyll, Inverclyde and Ayrshire. Total area = 13,710km^2 
...
SW_strandings <- SW_strandings %>%
  filter(County %in% c("Devon", "Somerset", "Cornwall", "North Somerset"))
