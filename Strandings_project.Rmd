...
All analysis uses the data: "cleandatenames.csv"
...
Can be done for any species - Here are some examples 
...
This was done for individual species but can easily be done for each species 
...
I have also produced decadal heatmaps to look at temporal changes over time 
- The resolution on these is not particularly good 
...
#Here, beaker stradnings in North west Scotland form 1989:2000 were investigated alongside #miltary data - but this code will be used to split up 
...
Plotting total stranded whales of species that strand 
